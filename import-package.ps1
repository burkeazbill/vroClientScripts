...
# PS C:\> ./import-package.ps1 -vroHost vro6.demo.lab -vroPort 8281 -user vcoadmin -pass vcoadmin -file c:\Packages\test.package
#
####################################################################
...
#request URL
$impUrl = "https://$($vroHost):$($vroPort)/vco/api/packages/?overwrite=true";
